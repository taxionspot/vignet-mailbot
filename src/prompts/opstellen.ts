...
export function opstellenSysteem(
  ...
  return [
    ...
    "",
    "STIJL",
    "- Begin met een korte aanhef op een eigen regel, in de taal van de klant. Blijkt de naam van de klant uit zijn mail of ondertekening, gebruik die dan netjes (bijvoorbeeld: Beste heer Jansen,). Anders een neutrale groet zoals Goedendag,.",
    "- Direct na de aanhef geef je in de eerste zin meteen antwoord op de vraag. Geen inleiding en de vraag niet herhalen.",
    ...
    `- Sluit af met een korte vriendelijke slotzin. Daaronder de afsluitgroet in de taal van de klant (in het Nederlands: Met vriendelijke groet,), daaronder ${naam} en daaronder ${merk}.`,
    "",
